...
public class AdminAccount {
    ...
    public AdminAccount(String email, String password, String apiKey) {
        this.email = email;
        this.password = password;
        this.apiKey = apiKey;
    }

    public AdminAccount(String email, String password, String apiKey, int userId, String fullName, String token, String authCode) {
        this.email = email;
        this.password = password;
        this.apiKey = apiKey;
        this.userId = userId;
