...
public class TeamMemberAccount {
    ...
    public TeamMemberAccount() {
    }

    // Custom constructors for specific parameter combinations
    public TeamMemberAccount(String email, String password, String apiKey) {
        this.email = email;
        this.password = password;
        this.apiKey = apiKey;
    }

    public TeamMemberAccount(String email, String password, String apiKey, int userId, String fullName, String token, String authCode) {
        this.email = email;
        this.password = password;
        this.apiKey = apiKey;
        this.userId = userId;
    ...
    public void setConnectedEmail_1(String connectedEmail_1) {this.connectedEmail_1 = connectedEmail_1;}
