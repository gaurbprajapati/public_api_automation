...
public class CustomRoleNothing {
    ...
    public CustomRoleNothing() {
    }

    // Custom constructors for specific parameter combinations
    public CustomRoleNothing(String email, String password, String apiKey) {
        this.email = email;
        this.password = password;
        this.apiKey = apiKey;
    }

    public CustomRoleNothing(String email, String password, String apiKey, int userId, String fullName, String token, String authCode) {
        this.email = email;
        this.password = password;
        this.apiKey = apiKey;
        this.userId = userId;
