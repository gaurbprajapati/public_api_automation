...
public class AddRecordsToHotlistTest extends TestBase {

	public AddRecordsToHotlistTest() {
	...
	public void addEntityInHotlist(String realtedToType, String entitySlug, String hotlistID, int httpStatus) {
	...
	public void verfiy200ForAddrecordToHotlist(Response response, int httpStatus, int HotlistID, String realtedToType,
		...
		response.then().body("related", Matchers.is(entitySlug));
	...
	public Object[][] getHotlistIdAndEntitySlug() {
		...
		Object data[][] = {
				...
				{ "company", companySlug, companyHotlistID, 200 }, { "contact", contactSlug, contactHotlistID, 200 },
				{ "job", jobSlug, jobHotlistID, 200 },

				{ "candidate", candidateEntitySlug + "1", candidateHotlistID, 422 },
				{ "company", companySlug + "1", companyHotlistID, 422 },
				{ "contact", contactSlug + "1", contactHotlistID, 422 }, 
				{ "job", jobSlug + "1", jobHotlistID, 422 },
				
				{ "candidate", candidateEntitySlug, candidateHotlistID+ "1", 422 },
				{ "company", companySlug, companyHotlistID+ "1", 422 },
				{ "contact", contactSlug, contactHotlistID+ "1", 422 }, 
				{ "job", jobSlug, jobHotlistID+ "1", 422 }
