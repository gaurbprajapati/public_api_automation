...
public class GetEntityOptedInTest extends TestBase {
    ...
    @Owner("Harika")
    @Test(dataProvider = "optInEvents", retryAnalyzer = WebhookRetryAnalyzer.class)
    public void getEntityOptedIn(String event) {
        function.deleteAllSubscriptions(baseURL, ThreadManager.getAccountApiKey());
        ...
        switch (event) {
            case "candidate.optedin":
                ...
                RestClient.doPost("JSON", baseURL, basePath, ThreadManager.getAccountApiKey(), null, true, optOutEmail);
        ...
        Assert.assertEquals(responseFromWebhook.get("is_email_opted_out"), "false");
    }
    ...
    @DataProvider(name = "optInEvents")
    public Object[][] dpMethod() {
        return new Object[][]{{"candidate.optedin"}, {"contact.optedin"}};
    }
}
