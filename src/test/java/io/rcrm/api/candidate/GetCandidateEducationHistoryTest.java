...
public class GetCandidateEducationHistoryTest extends TestBase {
	...
	public void getCandidateEducationHistoryVerify200() {
		Map<String, String> pathParamters = new HashMap<String, String>();
	...
	public void getCandidateEducationHistoryVerify404() {
		Map<String, String> pathParamters = new HashMap<String, String>();
		pathParamters.put("candidate", slug + "12345");
	...
	public void getCandidateWorkExperienceVerify401() {
		Map<String, String> pathParamters = new HashMap<String, String>();
		pathParamters.put("candidate", slug);
