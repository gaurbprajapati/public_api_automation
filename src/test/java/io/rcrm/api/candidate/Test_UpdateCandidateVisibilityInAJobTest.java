...
public class Test_UpdateCandidateVisibilityInAJobTest extends TestBase {

	public Test_UpdateCandidateVisibilityInAJobTest() {
	...
	public void userShouldUpdateCandidateVisibilityInAJob(String Candidateslug, String JobSlug,
			int getStatusID) {
		...
		//response.then().body("visibility", Matchers.is(0));
		...
		response.then().body("updated_by", Matchers.notNullValue());
		  ...
		  pathParamter.put("job",JobSlug);
		  
		  Map<String, String> queryParameters = new HashMap<String, String>();
		  queryParameters.put("visibility", "1");
		
		  
		  String basePath1 = "candidates/{candidate}/visibility/{job}";
		  Response response2= RestClient.doPost1("JSON", baseURL, basePath1, ThreadManager.getAccountApiKey(), queryParameters, pathParamter,
					true, null);
		...
		// Verify Response using Assertion and Jsonpath
			...
			int visibility = jp.get("visibility");
		  
		  response2.then().body("visibility", Matchers.is(visibility));
