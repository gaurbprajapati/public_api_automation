...
public class TrackAdvertTest extends TestBase {
	...
	public void trackingJobStatusUsingTrackAdvertLogicmelonTest(int job_id, String job_slug) {
		LogicmelonJobBoard logicmelonjobboard = new LogicmelonJobBoard();
		logicmelonjobboard.setJob_slug(job_slug);

		String basePath = "/logicmelon/track-advert";
	...
	public Object[][] createJobForPostingDataProvider() {
		JsonPath companyJp = commonfunction.createNewCompanyWithMandatoryFields(baseURL, ThreadManager.getAccountApiKey()).jsonPath();
		String company_slug = companyJp.get("slug");
