...
public class AICopilotPlacementHistoryToolTests extends TestBase {
    ...
    public void setup() {
        ...
        createTestPlacementHistoryData();
    }

    private void createTestPlacementHistoryData() {
        String candidate1Slug = createCandidateAndGetSlug("John_Doe_Placed_5Days");
        String company1Slug = createCompany("TechCorp_History1");
        String contact1Slug = createContact("Contact_History1", company1Slug);
        String job1Slug = createJobAndGetSlug("Software_Engineer_Job_5Days", company1Slug, contact1Slug);
        assignCandidateToJob(candidate1Slug, job1Slug);
        
        String candidate2Slug = createCandidateAndGetSlug("Jane_Smith_Placed_15Days");
        String company2Slug = createCompany("DataInc_History2");
        String contact2Slug = createContact("Contact_History2", company2Slug);
        String job2Slug = createJobAndGetSlug("Data_Analyst_Job_15Days", company2Slug, contact2Slug);
        assignCandidateToJob(candidate2Slug, job2Slug);
        
        String candidate3Slug = createCandidateAndGetSlug("Bob_Johnson_Placed_25Days");
        String company3Slug = createCompany("ManageCo_History3");
        String contact3Slug = createContact("Contact_History3", company3Slug);
        String job3Slug = createJobAndGetSlug("Project_Manager_Job_25Days", company3Slug, contact3Slug);
        assignCandidateToJob(candidate3Slug, job3Slug);
        
        String candidate4Slug = createCandidateAndGetSlug("Alice_Brown_Placed_30Days");
        String company4Slug = createCompany("DevOpsCo_History4");
        String contact4Slug = createContact("Contact_History4", company4Slug);
        String job4Slug = createJobAndGetSlug("DevOps_Engineer_Job_30Days", company4Slug, contact4Slug);
    ...
    private String createCandidateAndGetSlug(String candidateName) {
        ...
        candidate.setSkill("Java, Python, SQL, DevOps, QA Testing, Project Management");
    ...
    private String createJobAndGetSlug(String jobName, String companySlug, String contactSlug) {
        ...
        job.setJob_description_text("Test job description for " + jobName + " - Successfully placed candidate");
        ...
        job.setJob_skill("Java, Python, SQL, DevOps, QA Testing, Project Management");
        job.setJob_status("1");
    ...
    @Test
    public void validateCandidatesPlacedLast30Days_GET() {
        String message = "All candidates assigned to job in last 30 days";
        ...
        Assert.assertTrue(toolNames.contains("get_assigned_candidates") ,
            "Expected tool 'get_assigned_candidates' for placed candidates queries");
