...
public class DeleteNoteByIDTest extends TestBase{
	
	String slug = "";

	public DeleteNoteByIDTest() {
	...
	public void deleteNoteByID_noteTest(String entityType, int noteID, int responseCode) {
	...
	public void unauthorizedUserShouldNotBeAbleToDeleteNoteByID_noteTest() {
		...
		Response response = RestClient.doDelete("JSON", baseURL, basePath, ThreadManager.getAccountApiKey()+"x001", null, pathParamters, true);
	...
	public Object[][] getNoteByIdWithValidData() {
		...
		Object data[][] = {
				...
				{ "contact", 1000 + contactNoteID, 404 }, { "job", 1000 + jobNoteID, 404 },{ "deal", 1000 + dealNoteID, 404 }
