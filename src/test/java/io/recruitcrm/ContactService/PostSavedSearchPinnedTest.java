...
public class PostSavedSearchPinnedTest extends TestBase {
    ...
    public void testSavedSearchPin_Success(int savedSearchId, String savedSearchName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/contact/savedSearchPinned.json"));
    }
    ...
    public void testSavedSearchUnpin_Success(int savedSearchId, String savedSearchName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/contact/savedSearchUnpinned.json"));
    }
    ...
    public void testSavedSearchPin_MissingSavedSearchId() {
        ...
        Response response = RestClient.doPost1("JSON", contactServiceURL, basePath, albatrossTkn, null, null, true, null);
    ...
    public void testSavedSearchUnpin_MissingSavedSearchId() {
        ...
        Response response = RestClient.doDelete("JSON", contactServiceURL, basePath, albatrossTkn, null, null, true);
