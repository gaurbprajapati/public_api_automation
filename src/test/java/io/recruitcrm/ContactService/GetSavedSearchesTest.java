...
public class GetSavedSearchesTest extends TestBase {
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "savedSearchData", groups = {"contact_service", "nightly-build"})
    public void getContactSavedSearch_success(int createdId, String createdName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/contact/getSavedSearches.json"));
    }
    ...
    public void verifySavedSearchList_sortByName() {
        ...
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/contact-saved-searches/search/get", ownerToken, queryParameters, true, payload);
        ...
        response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/contact-saved-searches/search/get", ownerToken, queryParameters, true, payload);
        response.then().statusCode(200);
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "pinData", groups = {"contact_service", "nightly-build"})
    public void testSavedSearch_isPinnedReflectsPinUnpin(int id) {
        ...
        // pin
        Response pinResp = RestClient.doPost1("JSON", contactServiceURL, "saved-searches/{savedSearch}/pinned-saved-search", ownerToken,
        ...
        // unpin
        Response unpinResp = RestClient.doDelete("JSON", contactServiceURL, "saved-searches/{savedSearch}/pinned-saved-search", ownerToken,
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "shareVisibilityData", groups = {"contact_service", "nightly-build"})
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "collaboratorsData", groups = {"contact_service", "nightly-build"})
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "comprehensiveData", groups = {"contact_service", "nightly-build"})
    public void testSavedSearch_ComprehensiveFieldValidation(int savedSearchId, String expectedName, int shareFlag,
        ...
        assertThat("Entity type should be contacts", (String) item.get("entityType"), equalTo("contacts"));
    ...
    public void testSavedSearchList_WithoutAuth() {
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/contact-saved-searches/search/get", null,
                queryParams(1, 15), true, buildSortBody("updatedon", "desc"));
        assertThat("Without auth should return 401 but got " + response.getStatusCode(), response.getStatusCode(), equalTo(401));
    }

    @Owner("Raj Pandey")
    @Test(groups = {"contact_service", "nightly-build"})
    public void testSavedSearchList_InvalidAuth() {
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/contact-saved-searches/search/get", ownerToken + "xyz",
                queryParams(1, 15), true, buildSortBody("updatedon", "desc"));
    ...
    public void testSavedSearchList_MissingQueryParameters() {
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/contact-saved-searches/search/get", ownerToken,
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "getSavedSearchesFiltersData", groups = {"contact_service", "nightly-build"})
    ...
    public Object[][] getCollaboratorsData() {
        ...
        int id = createSavedSearch("ContactsList_Collab_" + System.currentTimeMillis(), 0, Collections.emptyList(), new ArrayList<>(userIds));
        return new Object[][]{{id, userIds}};
    }

    @DataProvider(name = "pinData")
    public Object[][] getPinData() {
        int id = createSavedSearch("ContactsList_PinFlip_" + System.currentTimeMillis(), 0, Collections.emptyList(), Collections.emptyList());
    ...
    public Object[][] getComprehensiveData() {
        ...
        String name = "ContactsList_Comprehensive_" + System.currentTimeMillis();
        int share = 1;
    ...
    private Response listSavedSearches(Object token, Map<String, Object> sort, int page, int size) {
        ...
        return RestClient.doPost("JSON", ariesServiceURL, "advanced-search/contact-saved-searches/search/get", token, queryParameters, true, createSavedSearchPayload((String) sort.get("field"), (String) sort.get("order")));
    }

    private JSONObject createSavedSearchPayload(String field, String order) {
        JSONObject payload = new JSONObject();
        payload.put("advancedSearchContext", "CONTACT_SAVED_SEARCH");
    ...
    public void createData() {
        JSONObject savedSearchData = readJsonFileFromPath("src/test/resources/contact_savedSearchData.json");
