...
public class GetContactHotlistTest extends TestBase{
    ...
    public void getContactHotlist_Success() {
        String basePath = "advanced-search/contact-hotlists/search/get";
        ...
        for (int i = 0; i < hotlists.size(); i++) {
            ...
            response.then().body(index + ".entityName", Matchers.equalTo("contacts"));
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("privateApi/contact/getHotlist.json"));

        List<String> expectedHotlistNames = new ArrayList<>(Arrays.asList("Hotlist Test [Owner][Today][Shared]", "Hotlist Test [Admin][Yesterday][Shared]", "Hotlist Test [Team Member][Last Week][Shared]", "Hotlist Test [Team Member][Last Month][Shared]", "Hotlist Test [Team Member][Last Quarter][Shared]", "Hotlist Test [Team Member][Last Year][Shared]", "Hotlist Test [Owner][Today][Not Shared]"));
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"contact_service", "nightly-build"})
    public void verifyContactHotlist_sortByName() {
        String basePath = "advanced-search/contact-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"contact_service", "nightly-build"})
    public void verifyContactHotlist_sortByCreatedOn() {
        String basePath = "advanced-search/contact-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"contact_service", "nightly-build"})
    public void verifyContactHotlist_sortByUpdatedOn() {
        String basePath = "advanced-search/contact-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
        ...
        Assert.assertTrue(isSorted(updatedOnList, "desc"), "Hotlists are not sorted by updatedOn in descending order. Values: " + updatedOnList);
    }

    @Owner("Raj Pandey")
    @Test(dataProvider = "getContactHotlistFiltersData", groups = {"contact_service", "nightly-build"})
    public void verifyContactHotlistFilters(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType) {
        String basePath = "advanced-search/contact-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @DataProvider(name = "getContactHotlistFiltersData", parallel = true)
    public Object[][] getContactHotlistFiltersData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/contactHotlistDataProvider.json");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"contact_service", "nightly-build"})
    public void getContactHotlist_WithoutAuth() {
        String basePath = "advanced-search/contact-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"contact_service", "nightly-build"})
    public void getContactHotlist_InvalidAuth() {
        String basePath = "advanced-search/contact-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
