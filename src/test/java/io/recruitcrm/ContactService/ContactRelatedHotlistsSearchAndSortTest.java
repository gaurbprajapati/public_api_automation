...
public class ContactRelatedHotlistsSearchAndSortTest extends TestBase {
    ...
    private void createTestData() {
        // Create company first (contacts need a company)
        ...
        contactRecordId = idObj instanceof Number ? ((Number) idObj).intValue() : Integer.parseInt(String.valueOf(idObj));

        assertThat("Record ID should not be null", contactRecordId, notNullValue());

        // Get user IDs to replace placeholders
        ...
        // Create hotlists from JSON data (reusable for all entities)
        ...
        String entityType = "contact"; // Set entity type dynamically
            ...
            CompletableFuture.allOf(
                IntStream.range(0, hotlists.length())
                    .mapToObj(i -> CompletableFuture.runAsync(() -> {
                        ...
                        // Create hotlist using JSONObject to include created_by
                        ...
                        assertThat("Failed to add contact to hotlist: " + hotlistName, addResponse.getStatusCode(), equalTo(200));
                    }, executor))
    ...
    @Owner("Harika")
    @Test(dataProvider = "hotlistSortOrderTestData", groups = {"contact_service", "nightly-build"})
    public void testContactRelatedHotlistsWithSortOrder(String sortField, String jsonPath, String sortOrder, int statusCode) {
        ...
        requestBody.put("recordId", contactRecordId);
        ...
        String testCase = "testContactRelatedHotlistsWithSortOrder - Field: " + sortField + ", Order: " + sortOrder;
    ...
    @Owner("Harika")
    @Test(dataProvider = "hotlistSearchTestData", groups = {"contact_service", "nightly-build"})
    public void testContactRelatedHotlistsSearch(String searchTerm, String searchType) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("size", "25");
        queryParams.put("page", "1");
    ...
    public Object[][] getHotlistSearchTestData() {
        return new Object[][] {
            ...
            // Special characters cases - based on updated hotlist names
            {"#1", "partial_match"},
            {"#", "partial_match"},
            {"& Cloud", "partial_match"},
