...
public class GetEntityWidgetsCustomizeAccountViewTest extends TestBase {
    ...
    @Owner("Harika")
    @Test(dataProvider = "validViewTypeDataProvider", groups = {"contact_service", "nightly-build"})
    public void testEntityWidgetsCustomizeAccountView_Success(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", contactServiceURL, basePath, albatrossAuthToken, queryParameters, null,
                true);

        response.then().assertThat().body(matchesJsonSchemaInClasspath("privateApi/contact/GetEntityWidgetsContactActivityWidgets.json"));
    ...
    public void testEntityWidgetsCustomizeAccountView_InvalidAuth(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", contactServiceURL, basePath, "InvalidToken", queryParameters, null,
                true);
    ...
    @Owner("Harika")
    @Test(dataProvider = "invalidViewTypeDataProvider", groups = {"contact_service", "nightly-build"})
    ...
    public void testEntityWidgetsCustomizeAccountView_WrongMethod(String viewType) {
        ...
        Response response = RestClient.doPost("JSON", contactServiceURL, basePath, albatrossAuthToken, queryParameters, true,
                null);
    ...
    public void verifyOtherUserCannotGetWidgetsCustomizeAccountView(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", contactServiceURL, basePath, teamMemberAuthToken, queryParameters, null, true);
    ...
    private void validateDataObjectDefaultValues(Response response, String viewType) {
        ...
        expectedVisibleIds.put("contact_widgets",
                IntStream.rangeClosed(1, 8).boxed().collect(Collectors.toList()));
        expectedVisibleIds.put("contact_activity_widgets",
