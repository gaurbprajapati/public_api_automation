...
public class GetSavedSearchCountTest extends TestBase {
    String apiAuthToken;
    ...
    public void getSavedSearchCountTest_Success() {
        String basePath = "advanced-search/contact-saved-searches/search/count/get";
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "getSavedSearchCountData", groups = {"contact_service", "nightly-build"})
    ...
    public Object[][] getSavedSearchCountData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/savedSearchCountDataProvider.json");
