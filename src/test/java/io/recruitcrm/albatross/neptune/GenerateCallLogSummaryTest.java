...
public class GenerateCallLogSummaryTest extends TestBase {
	JavaFakerSummary javaFakerSummary = new JavaFakerSummary();

	@Owner("Divya")
	@Test(dataProvider = "getKeyData", groups = "nightly-build")
	public void generateCallLogSummary_Test(String key) {
	...
	public void generateCallLogSummaryWithInvalidKey_Test() {
	...
	@Owner("Divya")
	@Test(groups = "nightly-build")
	public void generateCallLogSummaryWithNullValues_Test() {
	...
	@Owner("Divya")
	@Test(groups = "nightly-build")
	public void unauthorizedUserCannotGenerateCallLogSummary_Test() {
