...
public class GetCandidateHotlistCountTest extends TestBase {
    String apiAuthToken;
    ...
    public void getCandidateHotlistCountTest_Success() {
        String basePath = "advanced-search/candidate-hotlists/search/count/get";
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void getCandidateHotlistCountTest_WithoutAuth() {
        String basePath = "advanced-search/candidate-hotlists/search/count/get";
        Map<String, String> queryParameters = new HashMap<>();
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void getCandidateHotlistCountTest_InvalidAuth() {
        String basePath = "advanced-search/candidate-hotlists/search/count/get";
        Map<String, String> queryParameters = new HashMap<>();
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "getCandidateHotlistCountData", groups = {"candidate_service", "nightly-build"})
    public void getCandidateHotlistCountTest_DataProvider(String dbField, String filterType, String filterValue, String fieldType, int count, String token) {
        String basePath = "advanced-search/candidate-hotlists/search/count/get";
        Map<String, String> queryParameters = new HashMap<>();
    ...
    @DataProvider(name = "getCandidateHotlistCountData", parallel = true)
    public Object[][] getCandidateHotlistCountData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/candidateHotlistCountDataProvider.json");
