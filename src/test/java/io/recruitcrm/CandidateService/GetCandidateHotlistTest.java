...
public class GetCandidateHotlistTest extends TestBase{
    ...
    public void getCandidateHotlist_Success() {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        ...
        for (int i = 0; i < hotlists.size(); i++) {
            ...
            response.then().body(index + ".entityName", Matchers.equalTo("candidates"));
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("privateApi/candidate/getHotlist.json"));
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void verifyCandidateHotlist_sortByName() {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void verifyCandidateHotlist_sortByCreatedOn() {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void verifyCandidateHotlist_sortByUpdatedOn() {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "getCandidateHotlistFiltersData", groups = {"candidate_service", "nightly-build"})
    public void verifyCandidateHotlistFilters(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType) {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @DataProvider(name = "getCandidateHotlistFiltersData", parallel = true)
    public Object[][] getCandidateHotlistFiltersData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/candidateHotlistDataProvider.json");
    ...
    private JSONObject createHotlistFilterPayload(String dbField, String filterType, String filterValue, String sortField, String sortOrder, String fieldType) {
        ...
        payload.put("advancedSearchContext", "CANDIDATE_HOTLIST");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void getCandidateHotlist_WithoutAuth() {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"candidate_service", "nightly-build"})
    public void getCandidateHotlist_InvalidAuth() {
        String basePath = "advanced-search/candidate-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    public void createData() {
        JSONObject hotlistData = readJsonFileFromPath("src/test/resources/candidate_hotlistData.json");
