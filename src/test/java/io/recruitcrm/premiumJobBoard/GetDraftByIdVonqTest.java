...
public class GetDraftByIdVonqTest extends TestBase {

	public GetDraftByIdVonqTest() {
		super();
	}
	...
	public void getSavedCampaignDraftByInvalidId() {
	...
	@Test(groups = "nightly-build")
	public void getSavedCampaignDraftByIdWihInvalidAuth() {
		Map<String, String> pathParamters = new HashMap<String, String>();
		pathParamters.put("id", String.valueOf(generatedRandomNumber));
		Response response = RestClient.doGet("JSON", jobBoardServiceURL, "vonq/campaigns/draft/{id}",
