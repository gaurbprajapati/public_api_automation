...
public class AccountViewColumnsInvoices_Test extends TestBase {
    ...
    public void getAccountViewColumnsWithValidToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");

        Response response = RestClient.doGet("JSON", invoiceServiceURL, basePath, albatrossTknA, queryParams, null, true);
        
        response.then().statusCode(200);
        response.then().assertThat().body("meta.message", Matchers.is("Invoices Columns Fetched"));
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithInvalidToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithoutToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithCrossAccountToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithAdminToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithTeamMemberToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithRestrictedTeamMemberToken_Test() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("entity", "invoices");
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithoutEntityParam_Test() {
    ...
    public void getAccountViewColumnsWithInvalidEntity_Test() {
        Map<String, String> queryParams = new HashMap<>();
    ...
    @Owner("Smit Patel")
    @Test(groups = "nightly-build")
    public void getAccountViewColumnsWithEmptyEntity_Test() {
        Map<String, String> queryParams = new HashMap<>();
