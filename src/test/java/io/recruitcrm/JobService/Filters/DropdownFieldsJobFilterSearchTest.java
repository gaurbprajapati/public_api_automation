...
public class DropdownFieldsJobFilterSearchTest extends FilterSearchBaseTest {
    ...
    public void ownerDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        ...
        Assert.assertEquals(response.jsonPath().get("meta.message"), "Entities retrieved successfully", "Message for field: " + fieldName + ", filterType: " + filterType + " and filterValue: " + filterValue + " is not 'Jobs fetched successfully'");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "statusDropdownFieldFilterSearchTestData", description = "Filter Search Test for Status Dropdown Field")
    public void statusDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
        ...
        JSONArray data = getFilteredData(response);
        FilterSearchReporter.logFieldValues(response, data, fieldName, "jobstatuslabel");
        validateMultiselectAndDropdownFilteredData(data, filterType, filterValue, fieldName, dbField, expectedResult, jobKeyToIdMap, jobIdToKeyMap, 15, "Job");
    }

    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "qualificationDropdownFieldFilterSearchTestData", description = "Filter Search Test for Qualification Dropdown Field")
    public void qualificationDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
        ...
        Assert.assertEquals(response.jsonPath().get("meta.message"), "Entities retrieved successfully", "Message for field: " + fieldName + ", filterType: " + filterType + " and filterValue: " + filterValue + " is not 'Entities retrieved successfully'");
        JSONArray data = getFilteredData(response);
        FilterSearchReporter.logFieldValues(response, data, fieldName, "qualificationlabel");
        validateMultiselectAndDropdownFilteredData(data, filterType, filterValue, fieldName, dbField, expectedResult, jobKeyToIdMap, jobIdToKeyMap, 15, "Job");
    }

    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "hiringPipelineDropdownFieldFilterSearchTestData", description = "Filter Search Test for Hiring Pipeline Dropdown Field")
    public void hiringPipelineDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        String filterValueForApi = replaceHiringPipelinePlaceholders(filterValue);
        
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValueForApi, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
        Response response = executeFilterSearch(payload, albatrossAuthToken, "jobs");
        Assert.assertEquals(response.getStatusCode(), 200, "Response code for field: " + fieldName + ", filterType: " + filterType + " and filterValue: " + filterValue + " is not 200");
        ...
        validateMultiselectAndDropdownFilteredData(data, filterType, filterValueForApi, fieldName, dbField, expectedResult, jobKeyToIdMap, jobIdToKeyMap, 15, "Job");
    }

    private String replaceHiringPipelinePlaceholders(String filterValue) {
        String filterValueForApi = filterValue;
        
        if (filterValueForApi.contains("{default_hiring_pipeline_id}")) {
            filterValueForApi = filterValueForApi.replace("{default_hiring_pipeline_id}", "0");
        }
        
        Integer pipeline1Id = hiringPipelineIdMap.get("hiring_pipeline_1");
        Integer pipeline2Id = hiringPipelineIdMap.get("hiring_pipeline_2");
        Integer pipeline3Id = hiringPipelineIdMap.get("hiring_pipeline_3");
        
        if (pipeline1Id != null) {
            filterValueForApi = filterValueForApi.replace("{hiring_pipeline_1_id}", String.valueOf(pipeline1Id));
        }
        if (pipeline2Id != null) {
            filterValueForApi = filterValueForApi.replace("{hiring_pipeline_2_id}", String.valueOf(pipeline2Id));
        }
        if (pipeline3Id != null) {
            filterValueForApi = filterValueForApi.replace("{hiring_pipeline_3_id}", String.valueOf(pipeline3Id));
        }
        
        return filterValueForApi;
    }
    ...
    public void createdByDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "updatedByDropdownFieldFilterSearchTestData", description = "Filter Search Test for Updated By Dropdown Field")
    public void updatedByDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "jobIndustryDropdownFieldFilterSearchTestData", description = "Filter Search Test for Job Industry Dropdown Field")
    public void jobIndustryDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "jobTypeDropdownFieldFilterSearchTestData", description = "Filter Search Test for Job Type Dropdown Field")
    public void jobTypeDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "jobFunctionDropdownFieldFilterSearchTestData", description = "Filter Search Test for Job Function Dropdown Field")
    public void jobFunctionDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "salaryTypeDropdownFieldFilterSearchTestData", description = "Filter Search Test for Salary Type Dropdown Field")
    public void salaryTypeDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
        ...
        Assert.assertEquals(response.jsonPath().get("meta.message"), "Entities retrieved successfully", "Message for field: " + fieldName + ", filterType: " + filterType + " and filterValue: " + filterValue + " is not 'Entities retrieved successfully'");
        JSONArray data = getFilteredData(response);
        FilterSearchReporter.logFieldValues(response, data, fieldName, "salarytypelable");
        validateMultiselectAndDropdownFilteredData(data, filterType, filterValue, fieldName, dbField, expectedResult, jobKeyToIdMap, jobIdToKeyMap, 15, "Job");
    }

    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "enableJobApplicationFormDropdownFieldFilterSearchTestData", description = "Filter Search Test for Enable Job Application Form Dropdown Field")
    public void enableJobApplicationFormDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "jobLocationTypeDropdownFieldFilterSearchTestData", description = "Filter Search Test for Job Location Type Dropdown Field")
    public void jobLocationTypeDropdownFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
        FilterSearchReporter.logInfo("Test Case ID: ", testCaseId);
        JSONObject payload = createFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType, filterValue_TYPE);
        FilterSearchReporter.logInfo("Account: ", email);
        FilterSearchReporter.logPayload(payload);
    ...
    public Object[][] ownerDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
    ...
    @DataProvider(name = "statusDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] statusDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
    ...
    @DataProvider(name = "qualificationDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] qualificationDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
    ...
    @DataProvider(name = "hiringPipelineDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] hiringPipelineDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Hiring Pipeline")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    ...
                    testData.add(new Object[]{key, test.getString("filterType"), filterValue, test.getString("dbField"), expectedResult, test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
                }
            }
        }
        return testData.toArray(new Object[0][0]);
    ...
    @DataProvider(name = "jobIndustryDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] jobIndustryDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Job Industry")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    testData.add(new Object[]{key, test.getString("filterType"), test.getString("filterValue"), test.getString("dbField"), test.getString("expectedResult"), test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
    ...
    @DataProvider(name = "jobTypeDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] jobTypeDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Job Type")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    testData.add(new Object[]{key, test.getString("filterType"), test.getString("filterValue"), test.getString("dbField"), test.getString("expectedResult"), test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
    ...
    @DataProvider(name = "jobFunctionDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] jobFunctionDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Job Function")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    testData.add(new Object[]{key, test.getString("filterType"), test.getString("filterValue"), test.getString("dbField"), test.getString("expectedResult"), test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
    ...
    @DataProvider(name = "salaryTypeDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] salaryTypeDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Salary Type")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    testData.add(new Object[]{key, test.getString("filterType"), test.getString("filterValue"), test.getString("dbField"), test.getString("expectedResult"), test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
    ...
    @DataProvider(name = "enableJobApplicationFormDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] enableJobApplicationFormDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Enable Job Application Form")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    testData.add(new Object[]{key, test.getString("filterType"), test.getString("filterValue"), test.getString("dbField"), test.getString("expectedResult"), test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
    ...
    @DataProvider(name = "jobLocationTypeDropdownFieldFilterSearchTestData", parallel = true)
    public Object[][] jobLocationTypeDropdownFieldFilterSearchTestData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/jobDropdownTypeFilterDataProvider.json");
        List<Object[]> testData = new ArrayList<>();
        for (String key : filterData.keySet()) {
            if (key.equals("Job Location Type")) {
                JSONArray tests = filterData.getJSONArray(key);
                for (int i = 0; i < tests.length(); i++) {
                    JSONObject test = tests.getJSONObject(i);
                    testData.add(new Object[]{key, test.getString("filterType"), test.getString("filterValue"), test.getString("dbField"), test.getString("expectedResult"), test.getString("fieldType"), test.getString("filterValue_TYPE"), test.optString("testCaseId", "")});
    ...
    private String processFilterValue(String filterValue, String fieldName) {
        ...
        while (matcher.find()) {
            ...
            if (fieldKey.startsWith("team") && !fieldKey.equals("teamMember")) {
                ...
                Integer statusId = jobStatusIdMap.get(fieldKey);
                if (statusId != null) {
                    actualValue = String.valueOf(statusId);
                }
            } else if (fieldName.equals("Qualification")) {
                Integer qualificationId = qualificationIdMap.get(fieldKey);
                if (qualificationId != null) {
                    actualValue = String.valueOf(qualificationId);
                }
            } else if (fieldName.equals("Hiring Pipeline")) {
                actualValue = fieldKey;
            } else if (fieldName.equals("Job Industry") || fieldName.equals("Job Type") || fieldName.equals("Job Function") || fieldName.equals("Salary Type")) {
                actualValue = fieldKey;
            } else if (fieldName.equals("Enable Job Application Form") || fieldName.equals("Job Location Type")) {
                actualValue = fieldKey;
            }
    ...
    public void ownerDropdownFieldFilterSearchSmokeTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE, String testCaseId) {
