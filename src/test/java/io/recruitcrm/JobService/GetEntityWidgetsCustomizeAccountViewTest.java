...
public class GetEntityWidgetsCustomizeAccountViewTest extends TestBase {
    ...
    @Owner("Harika")
    @Test(dataProvider = "validViewTypeDataProvider", groups = {"job_service", "nightly-build"})
    public void testEntityWidgetsCustomizeAccountView_Success(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", jobServiceURL, basePath, albatrossAuthToken, queryParameters, null,
                true);

        response.then().assertThat().body(matchesJsonSchemaInClasspath("privateApi/job/GetEntityWidgetsJobActivityWidgets.json"));
    ...
    public void testEntityWidgetsCustomizeAccountView_WithoutAuth(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", jobServiceURL, basePath, null, queryParameters, null, true);
    ...
    public void testEntityWidgetsCustomizeAccountView_InvalidAuth(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", jobServiceURL, basePath, "InvalidToken", queryParameters, null,
                true);
    ...
    @Owner("Harika")
    @Test(dataProvider = "invalidViewTypeDataProvider", groups = {"job_service", "nightly-build"})
    ...
    public void testEntityWidgetsCustomizeAccountView_WrongMethod(String viewType) {
        ...
        Response response = RestClient.doPost("JSON", jobServiceURL, basePath, albatrossAuthToken, queryParameters, true,
                null);
    ...
    public void verifyOtherUserCannotGetWidgetsCustomizeAccountView(String viewType) {
        ...
        Response response = RestClient.doGet("JSON", jobServiceURL, basePath, teamMemberAuthToken, queryParameters, null, true);
    ...
    private void validateDataObjectDefaultValues(Response response, String viewType) {
        ...
        expectedVisibleIds.put("job_widgets",
                IntStream.rangeClosed(1, 10).boxed().collect(Collectors.toList()));
        expectedVisibleIds.put("job_activity_widgets",
