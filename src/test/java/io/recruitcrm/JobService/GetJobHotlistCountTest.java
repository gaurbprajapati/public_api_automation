...
public class GetJobHotlistCountTest extends TestBase {
    String apiAuthToken;
    ...
    public void getJobHotlistCountTest_Success() {
        String basePath = "advanced-search/job-hotlists/search/count/get";
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void getJobHotlistCountTest_WithoutAuth() {
        String basePath = "advanced-search/job-hotlists/search/count/get";
        Map<String, String> queryParameters = new HashMap<>();
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void getJobHotlistCountTest_InvalidAuth() {
        String basePath = "advanced-search/job-hotlists/search/count/get";
        Map<String, String> queryParameters = new HashMap<>();
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "getJobHotlistCountData", groups = {"job_service", "nightly-build"})
    public void getJobHotlistCountTest_DataProvider(String dbField, String filterType, String filterValue, String fieldType, int count, String token) {
        String basePath = "advanced-search/job-hotlists/search/count/get";
        Map<String, String> queryParameters = new HashMap<>();
    ...
    @DataProvider(name = "getJobHotlistCountData", parallel = true)
    public Object[][] getJobHotlistCountData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/jobHotlistCountDataProvider.json");
    ...
    private JSONObject createHotlistCountPayload(String sortField, String sortOrder) {
        ...
        payload.put("advancedSearchContext", "JOB_HOTLIST");
    ...
    public void createData() {
        JSONObject hotlistData = readJsonFileFromPath("src/test/resources/job_hotlistData.json");
