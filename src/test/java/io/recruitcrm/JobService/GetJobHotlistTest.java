...
public class GetJobHotlistTest extends TestBase{
    ...
    public void getJobHotlist_Success() {
        String basePath = "advanced-search/job-hotlists/search/get";
        ...
        for (int i = 0; i < hotlists.size(); i++) {
            ...
            response.then().body(index + ".entityName", Matchers.equalTo("jobs"));
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("privateApi/job/getHotlist.json"));
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void verifyJobHotlist_sortByName() {
        String basePath = "advanced-search/job-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void verifyJobHotlist_sortByCreatedOn() {
        String basePath = "advanced-search/job-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void verifyJobHotlist_sortByUpdatedOn() {
        String basePath = "advanced-search/job-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "getJobHotlistFiltersData", groups = {"job_service", "nightly-build"})
    public void verifyJobHotlistFilters(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType) {
        String basePath = "advanced-search/job-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @DataProvider(name = "getJobHotlistFiltersData", parallel = true)
    public Object[][] getJobHotlistFiltersData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/jobHotlistDataProvider.json");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void getJobHotlist_WithoutAuth() {
        String basePath = "advanced-search/job-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"job_service", "nightly-build"})
    public void getJobHotlist_InvalidAuth() {
        String basePath = "advanced-search/job-hotlists/search/get";
        Map<String, String> queryParameters = new HashMap<>();
        queryParameters.put("page", "1");
        queryParameters.put("size", "15");
