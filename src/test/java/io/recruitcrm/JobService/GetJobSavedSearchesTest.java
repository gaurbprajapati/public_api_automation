...
public class GetJobSavedSearchesTest extends TestBase {
    ...
    @Owner("Rahul Shibu")
    @Test(dataProvider = "savedSearchData", groups = {"job_service", "nightly-build"})
    public void getJobSavedSearch_success(int createdId, String createdName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/job/getSavedSearches.json"));
    }
    ...
    public void verifySavedSearchList_sortByName() {
        ...
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/job-saved-searches/search/get", ownerToken, queryParameters, true, payload);
        ...
        response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/job-saved-searches/search/get", ownerToken, queryParameters, true, payload);
        response.then().statusCode(200);
    ...
    @Owner("Rahul Shibu")
    @Test(dataProvider = "pinData", groups = {"job_service", "nightly-build"})
    public void testSavedSearch_isPinnedReflectsPinUnpin(int id) {
        ...
        // pin
        Response pinResp = RestClient.doPost1("JSON", ariesServiceURL, "saved-searches/{savedSearch}/pinned-saved-search", ownerToken,
        ...
        // unpin
        Response unpinResp = RestClient.doDelete("JSON", jobServiceURL, "saved-searches/{savedSearch}/pinned-saved-search", ownerToken,
    ...
    @Owner("Rahul Shibu")
    @Test(dataProvider = "shareVisibilityData", groups = {"job_service", "nightly-build"})
    ...
    @Owner("Rahul Shibu")
    @Test(dataProvider = "collaboratorsData", groups = {"job_service", "nightly-build"})
    ...
    @Owner("Rahul Shibu")
    @Test(dataProvider = "comprehensiveData", groups = {"job_service", "nightly-build"})
    public void testSavedSearch_ComprehensiveFieldValidation(int savedSearchId, String expectedName, int shareFlag,
        ...
        assertThat("Entity type should be jobs", (String) item.get("entityType"), equalTo("jobs"));
    ...
    public void testSavedSearchList_WithoutAuth() {
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/job-saved-searches/search/get", null,
    ...
    public void testSavedSearchList_InvalidAuth() {
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/job-saved-searches/search/get", ownerToken + "xyz",
                queryParams(1, 15), true, buildSortBody("updatedon", "desc"));
    ...
    public void testSavedSearchList_MissingQueryParameters() {
        Response response = RestClient.doPost("JSON", ariesServiceURL, "advanced-search/job-saved-searches/search/get", ownerToken,
    ...
    @Owner("Rahul Shibu")
    @Test(dataProvider = "getSavedSearchesFiltersData", groups = {"job_service", "nightly-build"})
    ...
    public Object[][] getCollaboratorsData() {
        ...
        int id = createSavedSearch("JobsList_Collab_" + System.currentTimeMillis(), 0, Collections.emptyList(), new ArrayList<>(userIds));
        return new Object[][]{{id, userIds}};
    }

    @DataProvider(name = "pinData")
    public Object[][] getPinData() {
        int id = createSavedSearch("JobsList_PinFlip_" + System.currentTimeMillis(), 0, Collections.emptyList(), Collections.emptyList());
    ...
    public Object[][] getComprehensiveData() {
        ...
        String name = "JobsList_Comprehensive_" + System.currentTimeMillis();
        int share = 1;
    ...
    public Object[][] getSavedSearchesFiltersData() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersTest/jobSavedSearchDataProvider.json");
    ...
    private Response listSavedSearches(Object token, Map<String, Object> sort, int page, int size) {
        ...
        return RestClient.doPost("JSON", ariesServiceURL, "advanced-search/job-saved-searches/search/get", token, queryParameters, true, createSavedSearchPayload((String) sort.get("field"), (String) sort.get("order")));
    }
    ...
    private int createSavedSearch(String name, int shareWithTeammates, List<Object> collaboratorIds, List<Object> collaboratorTypes) {
        ...
        savedSearch.setEntitytype("jobs");
