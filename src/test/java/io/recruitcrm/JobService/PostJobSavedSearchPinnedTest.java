...
public class PostJobSavedSearchPinnedTest extends TestBase {
    ...
    public void testSavedSearchPin_Success(int savedSearchId, String savedSearchName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/job/savedSearchPinned.json"));
    }
    ...
    public void testSavedSearchUnpin_Success(int savedSearchId, String savedSearchName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/job/savedSearchUnpinned.json"));
    }
    ...
    public void testSavedSearchPin_MissingSavedSearchId() {
        ...
        Response response = RestClient.doPost1("JSON", jobServiceURL, basePath, albatrossTkn, null, null, true, null);
    ...
    public void testSavedSearchUnpin_MissingSavedSearchId() {
        ...
        Response response = RestClient.doDelete("JSON", jobServiceURL, basePath, albatrossTkn, null, null, true);
