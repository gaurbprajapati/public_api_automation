...
public class PostJobHotlistPinnedTest extends TestBase {
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "hotlistData", groups = {"job_service", "nightly-build"})
    public void testHotlistPin_Success(String hotlistId, String hotlistName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/job/hotlistPinned.json"));
    }
    ...
    public void testHotlistUnpin_Success(String hotlistId, String hotlistName) {
        ...
        // Validate JSON schema using existing schema
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/job/hotlistUnpinned.json"));
    }
    ...
    public void testHotlistPin_WithoutAuth() {
        String randomHotlistId = String.valueOf(new Random().nextInt(1000000) + 1000000);
        Response response = pinHotlist(randomHotlistId, null);

        JsonPath jp = response.jsonPath();
        assertThat("Expected status code 400 but got " + response.getStatusCode(),
                response.getStatusCode(), equalTo(401));

        assertThat("Expected data should be null", jp.get("data"), Matchers.equalTo("Invalid or expired token"));
    }
    ...
    public void testHotlistUnpin_WithoutAuth() {
        String randomHotlistId = String.valueOf(new Random().nextInt(1000000) + 1000000);
        Response response = unpinHotlist(randomHotlistId, null);
    ...
    public void testHotlistPin_InvalidAuth() {
        String randomHotlistId = String.valueOf(new Random().nextInt(1000000) + 1000000);
        Response response = pinHotlist(randomHotlistId, albatrossTkn+"123");
    ...
    public void testHotlistUnpin_InvalidAuth() {
        String randomHotlistId = String.valueOf(new Random().nextInt(1000000) + 1000000);
        Response response = unpinHotlist(randomHotlistId, albatrossTkn+"123");
    ...
    public void testHotlistPin_InvalidHotlistId() {
        String randomInvalidHotlistId = String.valueOf(new Random().nextInt(1000000) + 1000000);
        Response response = pinHotlist(randomInvalidHotlistId, albatrossTkn);

        JsonPath jp = response.jsonPath();
        assertThat("Expected status code 400 but got " + response.getStatusCode(),
                response.getStatusCode(), equalTo(404));

        assertThat("Expected message should be Hotlist not found", jp.get("errors[0].message"), equalTo("Hotlist not found."));
    }
    ...
    public void testHotlistUnpin_InvalidHotlistId() {
        String randomInvalidHotlistId = String.valueOf(new Random().nextInt(1000000) + 1000000);
        Response response = unpinHotlist(randomInvalidHotlistId, albatrossTkn);
    ...
    public void testHotlistPin_MissingHotlistId() {
        ...
        assertThat("Expected error should be Not Found", jp.get("error"), equalTo("Not Found"));
    }
    ...
    private Response pinHotlist(String hotlistId, Object token) {
        ...
        return RestClient.doPost1("JSON", jobServiceURL, basePath, token, null, pathParameters, true, null);
    }
    ...
    private Response unpinHotlist(String hotlistId, Object token) {
        ...
        pathParameters.put("hotlist", hotlistId);
        String basePath = "hotlists/{hotlist}/pinned-hotlist";
        return RestClient.doDelete("JSON", jobServiceURL, basePath, token, null, pathParameters, true);
    }
}
