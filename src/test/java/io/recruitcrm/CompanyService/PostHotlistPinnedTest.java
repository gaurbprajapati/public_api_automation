...
public class PostHotlistPinnedTest extends TestBase {
    ...
    @Owner("Raj Pandey")
    @Test(dataProvider = "hotlistData", groups = {"company_service", "nightly-build"})
    public void testHotlistPin_Success(String hotlistId, String hotlistName) {
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/company/hotlistPinned.json"));
    }
    ...
    public void testHotlistUnpin_Success(String hotlistId, String hotlistName) {
        ...
        // Validate JSON schema using existing schema
        response.then().assertThat().body(matchesJsonSchemaInClasspath("publicApi/company/hotlistUnpinned.json"));
    }
