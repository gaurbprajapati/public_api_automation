...
public class CallLogActivityFieldsCompanyFilterSearchTest extends FilterSearchBaseTest {
    ...
    public Object[][] callLogDateFieldDataProvider() {
        JSONObject filterData = readJsonFileFromPath("src/test/resources/filtersDataProvider/companyCallLogFilterDataProvider.json");
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "callLogDateFieldFilterSearchTestData", description = "Call Log Activity Fields Company Filter Search Test")
    public void callLogDateFieldFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType, String filterValue_TYPE) {
    ...
    @Owner("Sai Teja SG")
    @Test(groups = {"aries_service"}, dataProvider = "callLogCallExistsFilterSearchTestData", description = "Call Log Exists (checkbox) Company Filter Search Test")
    public void callLogCallExistsFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult, String fieldType) {
    ...
    public void validateDateFilteredData(JSONArray data, String filterType, String filterValue, String fieldName, String dbField, String expectedResult) {
        for (int i = 0; i < data.length(); i++) {
            ...
            Response callLogResponse = getCompanyCallLogsBySlug(albatrossURL, albatrossAuthToken, companySlug);
            ...
            Assert.assertTrue(foundMatchingRecord, 
                "No matching call log record found for company ID: " + companySlug + 
                " with field: " + fieldName + ", filterType: " + filterType + ", filterValue: " + filterValue);
        }
    }

    public Response getCompanyCallLogsBySlug(String albatrossURL, String authToken, String companySlug) {
        ...
        Assert.assertEquals(response.getStatusCode(), 200, "Failed to fetch company call logs data");
        return response;
    }
    ...
    @Owner("Raj Pandey")
    @Test(groups = {"aries_service"}, dataProvider = "callLogMultiselectAndDropdownFilterSearchTest", description = "Call Log Activity Fields Company Filter Search Test")
    public void callLogMultiselectFilterSearchTest(String fieldName, String filterType, String filterValue, String dbField, String expectedResult,String fieldType) {
        JSONObject payload = createMultiselectAndDropdownFilterSearchPayload(fieldName, filterType, filterValue, dbField, fieldType);
        FilterSearchReporter.logInfo("Account: ",email);
        FilterSearchReporter.logPayload(payload);
    ...
    public JSONObject createMultiselectAndDropdownFilterSearchPayload(String fieldName, String filterType, String filterValue, String dbField, String fieldType) {
        ...
        } else if (dbField.equals("call_log_exists")) {
            String processedFilterValue = processFilterValue(filterValue);
    ...
    public void createTestData() {
        ...
        try {
            ...
            List<Integer> callLogIds = createCallLogForCompany(companySlugMap);
        ...
        try {
            ...
            for (String companyKey : companySlugMap.keySet()) {
                ...
                futures.add(CompletableFuture.runAsync(() -> {
                    ...
                    JSONObject payload = processPayload(callLogsData, companySlug);
    ...
    private JSONObject processPayload(JSONObject payload, String companySlug) {
