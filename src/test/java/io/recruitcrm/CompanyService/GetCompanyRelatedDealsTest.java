...
public class GetCompanyRelatedDealsTest extends TestBase {
    ...
    @Owner("Suhel Bhadane")
    @Test(dataProvider = "companyRelatedDealsTestData", groups = {"company_service", "nightly-build"})
    public void testGetCompanyRelatedDealsSuccess(String companySlug, int dealId, String companyName) {
        ...
        Response response = RestClient.doPost1("JSON", companyServiceURL, "companies/{companySlug}/related-deals",
        ...
        if (jp.get("data.deals.size()") != null && (Integer) jp.get("data.deals.size()") > 0) {
            ...
            assertThat("Company slug should match", jp.get("data.deals[0].companyslug"), equalTo(companySlug));
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("schemaValidation/privateApi/company/companyRelatedDeals.json"));
    }

    @Owner("Suhel Bhadane")
    @Test(dataProvider = "companyRelatedDealsTestData", groups = {"company_service", "nightly-build"})
    public void testGetCompanyRelatedDealsWithoutAuth(String companySlug, int dealId, String companyName) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("page", "1");
        queryParams.put("size", "25");
    ...
    @Owner("Suhel Bhadane")
    @Test(dataProvider = "companyRelatedDealsTestData", groups = {"company_service", "nightly-build"})
    public void testGetCompanyRelatedDealsInvalidAuth(String companySlug, int dealId, String companyName) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("page", "1");
        queryParams.put("size", "25");
    ...
    public void testGetCompanyRelatedDealsInvalidCompanySlug() {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("page", "1");
        queryParams.put("size", "25");
        ...
        Map<String, String> pathParams = new HashMap<>();
        pathParams.put("companySlug", "invalid-company-slug-12345");
        ...
        assertThat("Error message should contain company not found", jp.get("errors[0].message"), containsString("Company not found for slug"));
    }

    @Owner("Suhel Bhadane")
    @Test(dataProvider = "companyRelatedDealsTestData", groups = {"company_service", "nightly-build"})
    public void testGetCompanyRelatedDealsEmptyRequestBody(String companySlug, int dealId, String companyName) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("page", "1");
        queryParams.put("size", "25");
    ...
    @Owner("Suhel Bhadane")
    @Test(dataProvider = "companyRelatedDealsSearchTestData", groups = {"company_service", "nightly-build"})
    public void testGetCompanyRelatedDealsSearch(String companySlug, String companyName, String searchTerm, String searchType) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("page", "1");
        queryParams.put("size", "25");
    ...
    @Owner("Suhel Bhadane")
    @Test(dataProvider = "companyRelatedDealsSortOrderTestData", groups = {"company_service", "nightly-build"})
    public void testGetCompanyRelatedDealsWithSortOrder(String companySlug, String companyName, String sortOrderName, JSONArray sortOrder) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("page", "1");
        queryParams.put("size", "25");
    ...
    @DataProvider(name = "companyRelatedDealsSortOrderTestData")
    public Object[][] getCompanyRelatedDealsSortOrderTestData() {
        ExecutorService executor = Executors.newFixedThreadPool(4);

        try {
            // Step 1 & 2: Create company and candidate in parallel (independent operations)
            ...
            // Wait for both company and candidate to be created
            ...
            JSONObject sortOrderJson = readJsonFileFromPath("src/test/resources/privateApi/company/companyRelatedDealsSortOrder.json");
    ...
    @DataProvider(name = "companyRelatedDealsSearchTestData")
    public Object[][] getCompanyRelatedDealsSearchTestData() {
        ExecutorService executor = Executors.newFixedThreadPool(4);
        ...
        try {
            ...
            // Step 2: Create candidate (required for deal creation)
            ...
            // Step 3: Create contacts in parallel (independent operations) - both for main company
            ...
            // Step 4: Create jobs in parallel (independent operations) - both for main company
            CompletableFuture<Response> job1Future = CompletableFuture.supplyAsync(() -> {
                Response response = function.createNewJob(baseURL, accountApiKey, companySlug, contact1Slug);
            ...
            CompletableFuture<Response> job2Future = CompletableFuture.supplyAsync(() -> {
                Response response = function.createNewJob(baseURL, accountApiKey, companySlug, contact2Slug);
            ...
            // Step 5: Create deals in parallel (independent operations) - both linked to main company
            Integer ownerUserId = function.getOwnerUserId(baseURL, accountApiKey);
            CompletableFuture<Response> deal1Future = CompletableFuture.supplyAsync(() -> {
                Deal deal1 = new Deal();
                deal1.setName("SearchTest Deal Alpha - " + companyName);
            ...
            CompletableFuture<Response> deal2Future = CompletableFuture.supplyAsync(() -> {
                Deal deal2 = new Deal();
                deal2.setName("SearchTest Deal Beta - " + companyName);
            ...
            return new Object[][]{
                    // {companySlug, companyName, searchTerm, searchType}
                    {companySlug, companyName, companyName, "exact_match"},
                    {companySlug, companyName, companyName.substring(0, Math.min(5, companyName.length())), "partial_match"},
                    {companySlug, companyName, companyName.toUpperCase(), "case_insensitive"},
                    {companySlug, companyName, companyName.toLowerCase(), "case_insensitive"},
                    {companySlug, companyName, "SearchTest", "partial_match"},
                    {companySlug, companyName, "NonExistentCompanyName12345", "no_results"}
            };
        } finally {
            executor.shutdown();
        }
    ...
    @DataProvider(name = "companyRelatedDealsTestData")
    public Object[][] getCompanyRelatedDealsTestData() {
        ...
        // Step 5: Create a deal linked to the company
        Deal deal = new Deal();
        ...
        return new Object[][]{{companySlug, dealId, companyName}};
    }
}