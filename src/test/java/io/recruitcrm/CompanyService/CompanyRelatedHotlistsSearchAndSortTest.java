...
public class CompanyRelatedHotlistsSearchAndSortTest extends TestBase {
    ...
    private void createTestData() {
        ...
        companyRecordId = jp.get("data.company.id");

        assertThat("Record ID should not be null", companyRecordId, notNullValue());
        ...
        String entityType = "company"; // Set entity type dynamically
            ...
            CompletableFuture.allOf(
                IntStream.range(0, hotlists.length())
                    .mapToObj(i -> CompletableFuture.runAsync(() -> {
                        ...
                        assertThat("Failed to add company to hotlist: " + hotlistName, addResponse.getStatusCode(), equalTo(200));
                    }, executor))
    ...
    @Owner("Harika")
    @Test(dataProvider = "hotlistSortOrderTestData", groups = {"company_service", "nightly-build"})
    public void testCompanyRelatedHotlistsWithSortOrder(String sortField, String jsonPath, String sortOrder, int statusCode) {
        ...
        requestBody.put("recordId", companyRecordId);
        ...
        String testCase = "testCompanyRelatedHotlistsWithSortOrder - Field: " + sortField + ", Order: " + sortOrder;
    ...
    @Owner("Harika")
    @Test(dataProvider = "hotlistSearchTestData", groups = {"company_service", "nightly-build"})
    public void testCompanyRelatedHotlistsSearch(String searchTerm, String searchType) {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("size", "25");
        queryParams.put("page", "1");
