...
public class UpdateCompanyDetailsPageFieldCountTest extends TestBase {
    ...
    @Owner("Harika")
    @Test(dataProvider = "updateFieldsCountTestData", groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountSuccess(int myViewFieldsCount, int otherViewFieldsCount) {

        // Step 1: Update field counts
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
        requestBody.put("myViewFieldsCount", myViewFieldsCount);
        requestBody.put("otherViewFieldsCount", otherViewFieldsCount);

        Response response = RestClient.doPut("JSON", companyServiceURL, "details-page/fields-count",
        ...
        response.then().assertThat().body(matchesJsonSchemaInClasspath("schemaValidation/privateApi/company/updateDetailsPageFieldsCount.json"));
    ...
    @Owner("Harika")
    @Test(dataProvider = "updateFieldsCountTestData", groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountWithoutAuth(int myViewFieldsCount, int otherViewFieldsCount) {
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
        requestBody.put("myViewFieldsCount", myViewFieldsCount);
        requestBody.put("otherViewFieldsCount", otherViewFieldsCount);
    ...
    @Owner("Harika")
    @Test(dataProvider = "updateFieldsCountTestData", groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountInvalidAuth(int myViewFieldsCount, int otherViewFieldsCount) {
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
        requestBody.put("myViewFieldsCount", myViewFieldsCount);
        requestBody.put("otherViewFieldsCount", otherViewFieldsCount);
    ...
    public void testUpdateCompanyDetailsPageFieldsCountEmptyRequestBody() {
        JSONObject requestBody = new JSONObject();
        // Empty request body
    ...
    @Owner("Harika")
    @Test(groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountMissingEntityType() {
        JSONObject requestBody = new JSONObject();
    ...
    @Owner("Harika")
    @Test(groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountInvalidEntityType() {
        JSONObject requestBody = new JSONObject();
    ...
    @Owner("Harika")
    @Test(groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountInvalidMyViewFieldsCount() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
    ...
    @Owner("Harika")
    @Test(groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountInvalidOtherViewFieldsCount() {
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
    ...
    @Owner("Harika")
    @Test(dataProvider = "negativeValuesTestData", groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountNegativeValues(int myViewFieldsCount, int otherViewFieldsCount) {
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
        requestBody.put("myViewFieldsCount", myViewFieldsCount);
        requestBody.put("otherViewFieldsCount", otherViewFieldsCount);
    ...
    @Owner("Harika")
    @Test(dataProvider = "zeroValuesTestData", groups = {"company_service", "nightly-build"})
    public void testUpdateCompanyDetailsPageFieldsCountZeroValues(int myViewFieldsCount, int otherViewFieldsCount) {
        JSONObject requestBody = new JSONObject();
        requestBody.put("entityType", "companies");
        requestBody.put("myViewFieldsCount", myViewFieldsCount);
        requestBody.put("otherViewFieldsCount", otherViewFieldsCount);
