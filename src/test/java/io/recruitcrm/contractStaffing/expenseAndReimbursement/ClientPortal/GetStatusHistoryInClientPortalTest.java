...
public class GetStatusHistoryInClientPortalTest extends ClientPortalExpenseReimbursementBaseTest {
    ...
    @Test(dataProvider = "reimbursementSubmittedRejectReopenApprovePortalData")
    public void getStatusHistoryWithClientTkn(int timesheetID, int reimbursementID, String portalToken) {
        ...
        assertThat(jp.getString("data[3].statusLabel"), is("Pending"));
        ...
        assertThat(jp.getString("data[1].statusLabel"), is("Pending"));
        ...
        for (int i = 0; i < 4; i++) {
            ...
            assertThat(jp.get("data[" + i + "].updatedBy.id"), notNullValue());
            assertThat(jp.get("data[" + i + "].updatedBy.name"), notNullValue());
            assertThat(jp.get("data[" + i + "].updatedBy.userTypeId"), notNullValue());
            assertThat(jp.get("data[" + i + "].updatedOn"), notNullValue());
        }
    }

    @Test(dataProvider = "addPortalTimesheetIdReimbursementIdTokenData")
    public void getReimbursementStatusHistoryAfterApprove_Client(int timesheetID, int reimbursementID,
            String portalToken) {
        ...
        assertThat(jp.getString("data[1].remark"), nullValue());
        ...
        assertThat(jp.getString("data[0].remark"), nullValue());
        assertThat(jp.get("data[0].createdBy.id"), notNullValue());
        assertThat(jp.get("data[0].createdBy.name"), notNullValue());
        assertThat(jp.get("data[0].createdBy.userTypeId"), notNullValue());
        assertThat(jp.get("data[0].createdOn"), notNullValue());
    }

    @Test(dataProvider = "addPortalTimesheetIdReimbursementIdTokenData")
    public void getStatusHistoryWithInvalidReimbursementId_Client(int timesheetID, int reimbursementID, String portalToken) {
    ...
    @Test(dataProvider = "addPortalTimesheetIdReimbursementIdTokenData")
    public void getStatusHistoryWithInvalidTimesheetId_Client(int timesheetID, int reimbursementID, String portalToken) {
    ...
    public void getStatusHistoryWithCrossAccountToken_Client(int timesheetID, int reimbursementID, String otherPortalToken) {
    ...
    public Object[][] reimbursementSubmittedRejectReopenApprovePortalData() {
        ...
        Response reject = updateReimbursementStatus(timesheetId, reimbursementID, "approve", WORKFLOW_REJECT_REMARK,
                portalToken);
