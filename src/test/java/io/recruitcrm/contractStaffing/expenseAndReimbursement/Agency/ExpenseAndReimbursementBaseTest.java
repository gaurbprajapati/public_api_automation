...
public abstract class ExpenseAndReimbursementBaseTest extends ContractStaffingBaseTest {
    ...
    protected Response createInvoiceForTimesheetsWithSyncFusion(List<Integer> timesheetIds,
        ...
        body.put("invoiceSfdt", sfdtAfter);
    ...
    public Object[][] buildAgencyData() {
        ...
        return new Object[][] { { timesheetId, reimbursementId, albatrossAuthToken } };
    }
