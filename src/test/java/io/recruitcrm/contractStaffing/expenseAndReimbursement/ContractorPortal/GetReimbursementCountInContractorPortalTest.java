...
public class GetReimbursementCountInContractorPortalTest extends ContractorPortalExpenseReimbursementBaseTest {

    @Test(dataProvider = "contractorPortalTimesheetWithoutReimbursementsData")
    public void getReimbursementCountWithoutReimbursements_Test_Contractor(int timesheetId, String portalToken) {
    ...
    @Test(dataProvider = "contractorPortalTimesheetWithTwoReimbursementsData")
    public void getReimbursementCountWithContractorTkn(int timesheetId, String portalToken) {
        Response response = getReimbursementCount(timesheetId, portalToken);
        assertThat(response.getStatusCode(), is(200));
        JsonPath jp = response.jsonPath();
        assertThat(jp.getString("meta.message"), is("Reimbursement count fetched successfully"));
    ...
    public void getReimbursementCountWithAnotherContractorId_Contractor(int timesheetID, int reimbursementID,
    ...
    public void getReimbursementCountWithInvalidTimesheetId_Contractor(int timesheetID, int reimbursementID,
            String portalToken) {
    ...
    @Test(dataProvider = "addContractorPortalTimesheetIdReimbursementIdTokenData")
    public void getReimbursementCountWithNegativeTimesheetId_Contractor(int timesheetID, int reimbursementID,
            String portalToken) {
    ...
    public Object[][] contractorPortalTimesheetWithoutReimbursementsData() {
        Object[] row = buildContractorPortalData(1, false);
        return new Object[][] { { row[3], row[5] } };
    }

    @DataProvider(parallel = true)
    public Object[][] contractorPortalTimesheetWithTwoReimbursementsData() {
        Object[] row = buildContractorPortalData(1, false);
